...
OLLAMA_API_KEY = os.getenv("OLLAMA_API_KEY", None)  # Optional for remote instances
...
def validate_settings():
    ...
    if not (GOOGLE_API_KEY or OPENAI_API_KEY or DEFAULT_LLM_PROVIDER == "ollama"):
        errors.append(
            "At least one LLM API key (GOOGLE_API_KEY, OPENAI_API_KEY) is required, or set DEFAULT_LLM_PROVIDER to 'ollama' for local usage."
        )
